...
@section('content')
@include('partials.admin.heading', [$heading = "Current Orders"])
@include('partials.admin.errors')
@include('partials.admin.errorMessage')

<br>
<div class="container">
  <form action="/home" method="post" class="form-inline justify-content-center">
      @csrf
          ...
          @include('partials.admin.showOrderDetails')
              ...
              <span class="dropright">
                ...
                <div class="dropdown-menu" aria-labelledby="OrderStatus-{{$order->id}}">
                  <a class="dropdown-item" href="{{ route('changeOrderStatusToRecd', ['id' => $order->id]) }}">Received</a>
                  <a class="dropdown-item" href="{{ route('changeOrderStatusToCooking', ['id' => $order->id]) }}">Cooking</a>
